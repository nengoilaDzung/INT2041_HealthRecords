                ...
                <Row>
                  ...
                  <Col size={"md-8"}>
                    ...
                    <p className="card-text">
                      This will remove {name !== "" ? name : "this patient"}{" "}
                      from your list.
                    </p>
                  </Col>
                </Row>
                ...
                <Row>
                  ...
                  <Col size={"md-8"}>
                    <h2 className="card-title">
                      Remove {name === "" ? "this patient" : name}
                    </h2>
                    <p className="card-text">
                      Delete {name !== "" ? name : "this patient"} from your
                      patient list?
                    </p>
                  </Col>
                  <Col size={"md-2"}>
                    <i
                      className="fas fa-user-times fa-2x rm-sm-user"
                      style={toggleBtn}
                    />
                  </Col>
                </Row>
