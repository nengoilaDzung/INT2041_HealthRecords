    ...
    <nav className={"navbar navbar-expand-lg navbar-light bg-light"}>
      ...
      <Collapse navState={navLinks} id={"target-collapse"}>
        <ul className="navbar-nav mr-auto">
          ...
          <li
            className={
              pathname === "/patients" ? "nav-item active" : "nav-item"
            }
            style={
          ...
          <li
            className={pathname === "/ehr" ? "nav-item active" : "nav-item"}
            style={
              pathname === "/ehr" || pathname === "/contacts"
                ? { display: "block" }
                : { display: "none" }
            }
          >
            <Link
              to={{ pathname: "/ehr", state: { patientId, name } }}
              className={"nav-link"}
            >
              {name ? `${name}'s` : ""} EHR
            </Link>
          ...
          <li
            className={
              pathname === "/contacts" ? "nav-item active" : "nav-item"
            }
            style={
              pathname === "/ehr" || pathname === "/contacts"
                ? { display: "block" }
          ...
          >
            <Link
              to={{ pathname: "/contacts", state: { patientId, name } }}
              className={"nav-link"}
            >
